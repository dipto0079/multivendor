                ...
                <div class="col-md-9 col-sm-8">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            @lang('messages.buyer.question_page.question_details')
                        </div>
                        <div class="panel-body">
                            ...
                            @endif
                            <hr>
                            {!! Form::open(['url'=>'/buyer/question/reply/save']) !!}
                            <div class="form-group">
                                ...
                                <br>
                                <button class="btn btn-primary pull-right" type="submit">@lang('messages.buyer.question_page.send')</button>
